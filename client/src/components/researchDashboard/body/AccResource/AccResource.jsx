...
function AccResource() {
  ...
  const [selectedAccResource, setSelectedAccResource] = useState(null);
  ...
  const handleSearch = (query) => {
    const filteredList = dataList.filter((AccResource) => {
      const fullName = `${AccResource.name} ${AccResource.target_aud} ${AccResource.date}`;
  ...
  const handleEditModalOpen = (accResource) => {
    setSelectedAccResource(accResource);
        ...
        <Modal show={editModalOpen} onHide={handleEditModalClose}>
          ...
          <Modal.Body>
            <ResourceAccessForm
              ...
              initialData={selectedAccResource}
            />
          </Modal.Body>
        </Modal>
