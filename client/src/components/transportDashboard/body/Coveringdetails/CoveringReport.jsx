...
const Address = () => (
  <View style={styles.titleContainer}>
    <View style={styles.spaceBetween}>
      <View>
        <Text style={styles.invoice}>Covering Report</Text>
...
const TableHead = () => {
  return (
    <View style={{ width:'100%', flexDirection :'row', marginTop:10}}>
      ...
      <View style={styles.theader}>
        <Text>Total Coverings (in km)</Text>   
      </View>
      <View style={styles.theader}>
        <Text>Date</Text>   
      </View>
...
const TableBody = () => {
  return (
    dataList.map((coverings) => (
      <Fragment key={coverings.id}>
        <View style={{ width:'100%', flexDirection :'row'}}>
          <View style={styles.tbody}>
            <Text>{new Date(coverings.vehicle_no).toLocaleDateString()}</Text>   
          </View>
          <View style={styles.tbody}>
            <Text>{coverings.owner_name}</Text>   
          </View>
          <View style={styles.tbody}>
            <Text>{coverings.total_coverings}</Text>   
          </View>
          <View style={styles.tbody}>
            <Text>{coverings.date}</Text>   
          </View>
