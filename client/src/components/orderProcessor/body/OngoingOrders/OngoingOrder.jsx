...
import OngoingOrderPopupForm from './OngoingOrderPopupForm';
          ...
          <div className="body" id='body'>
              <div className="card recent-sales overflow-auto">
                  ...
                  <div className="card-body">
                      ...
                      <SearchBar/>
                      <OngoingOrderTable items={items} updateQualityList={getQualityList} editItem={handleEdit}/>
                  </div>
                  <div>
                      <OngoingOrderPopupForm
                          show={showModal}
