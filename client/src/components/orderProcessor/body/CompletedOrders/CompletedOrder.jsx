...
import CompletedOrderPopupForm from './CompletedOrderPopupForm';
          ...
          <div className="body" id='body'>
              <div className="card recent-sales overflow-auto">
                  ...
                  <div className="card-body">
                      ...
                      <SearchBar/>
                      <CompletedOrderTable items={items} updateQualityList={getQualityList} editItem={handleEdit}/>
                  </div>
                  <div>
                      <CompletedOrderPopupForm
                          show={showModal}
