...
const AddQualityModal = ({ show, handleClose, handleSubmit, handleOnChange, rest }) => {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h1 className="modal-title fs-5" id="exampleModalLabel">Add Quality</h1>
...
export default AddQualityModal;